            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    if(firebaseAuth.getCurrentUser().isEmailVerified()){
                        //go to mainactivity
                        startActivity(new Intent(Login.this,HomeActivity22.class));
                        finish();
                    }else{
                        Toast.makeText(Login.this, "Email not verified. Please Verified your email", Toast.LENGTH_SHORT).show();
                    }
